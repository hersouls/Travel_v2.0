    ...
    <div className={`min-h-screen flex items-center justify-center relative overflow-hidden ${className}`}>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
        <div className="mb-6 sm:mb-8 animate-fade-in">
          ...
          <Typography variant="h3" className="text-moonwave-200 mb-6 sm:mb-8 text-responsive-lg">
            오안나의 음악 여정
          </Typography>
        </div>
        ...
        <div className="animate-slide-up" style={{ animationDelay: '1s' }}>
          <Button
            onClick={onStart}
            size="lg"
            className="bg-gradient-to-r from-moonwave-500 to-moonwave-600 hover:from-moonwave-600 hover:to-moonwave-700 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-xl shadow-glow btn-touch"
          >
            음악으로 만나기
          </Button>
        </div>
